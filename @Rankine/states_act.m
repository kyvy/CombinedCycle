...
obj.states.act(2) = pump_actual(obj.states.isn(1), obj.states.isn(2));
obj.states.act(4) = pump_actual(obj.states.isn(3), obj.states.isn(4));
obj.states.act(6) = pump_actual(obj.states.isn(5), obj.states.isn(6));

obj.states.act(8)  = turbine_actual(obj.states.isn(7), obj.states.isn(8));
obj.states.act(10) = turbine_actual(obj.states.isn(9), obj.states.isn(10));
obj.states.act(11) = turbine_actual(obj.states.isn(9), obj.states.isn(11));
